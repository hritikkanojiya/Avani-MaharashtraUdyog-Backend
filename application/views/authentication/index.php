...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>
        body {
            background-image: url('<?= ASSETS_URL ?>/assets/media/auth/bg4.jpg');
        }

        [data-bs-theme="dark"] body {
            background-image: url('<?= ASSETS_URL ?>/assets/media/auth/bg4-dark.jpg');
        }
        </style>
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                <div class="d-flex flex-center flex-lg-start flex-column">
                    <a href="<?= BASE_URL ?>" class="mb-7 m-auto">
                        <img alt="Logo" width="250px" src="<?= ASSETS_URL ?>/assets/media/logos/logo.png" />
                    </a>
            ...
            <div
                ...
                <div
                    class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px px-20 py-15 mh-lg-550px my-auto">
                    <div class="d-flex flex-center flex-column flex-column-fluid p-15 p-lg-10">
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            data-kt-redirect-url="<?= BASE_URL ?>" action="<?= BASE_URL ?>/auth/sign_in">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <a href="#" class="link-primary" data-bs-toggle="tooltip" data-bs-placement="right"
                                    data-bs-custom-class="tooltip-inverse"
                                    title="Contact Development Team to reset your password">Forgot Password ?</a>
                            </div>
                            <div class="d-grid">
