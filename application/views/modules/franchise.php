                            ...
                            <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                                ...
                                <div class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                                    <span class="menu-link">
                                        <a class="menu-title" href="<?= BASE_URL ?>/modules/applications">Applications</a>
                                        <span class="menu-arrow d-lg-none"></span>
                                    </span>
                                </div>
                                <div class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="<?= BASE_URL ?>/modules/applications">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <table id="kt_datatable_fixed_header" class="table border table-rounded table-row-dashed table-hover gy-5 gs-7">
                                        <thead class="bg-gray-200 fw-bold">
                                            <tr class="fw-semibold fs-6 text-gray-800">
                                                ...
                                                <th class="mw-100px mw-lg-250px">Franchise Details</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($franchise) && is_array($franchise) && count($franchise) > 0) {
                                                ...
                                                foreach ($franchise as $key => $value) {
                                                    ...
                                                    $tableDom .=  "<td class='text-truncate mw-100px mw-lg-250px'>" . $value['franchise_details'] . "</td>";
