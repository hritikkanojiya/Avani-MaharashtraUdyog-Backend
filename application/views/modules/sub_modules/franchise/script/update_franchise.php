<script>
$(document).ready(() => {
    var franchiseFormDomElement = document.getElementById('franchise_update_details_form');
    var franchiseForm = $("#franchise_update_details_form");
    var franchiseFormUpdateBtn = $("#update_franchise_details");
    ...
    franchiseFormUpdateBtn.on("click", function(event) {
        event.preventDefault();
        franchiseFormValidation
            .validate()
            .then(function(status) {
                if (status === 'Valid') {
                    franchiseFormUpdateBtn
                    ...
                    $.ajax({
                                ...
                                if (parsedResponse?.status != "success") {
                                    Swal.fire({
                                        text: parsedResponse?.message ?
                                            parsedResponse
                                            .message :
                                            "Sorry, the details are incorrect, please try again.",
                                        icon: "error",
                        ...
                        .always(function() {
                            franchiseFormUpdateBtn.removeAttr('data-kt-indicator')
                                .prop('disabled', false);
                        });
                } else {
                    Swal.fire({
