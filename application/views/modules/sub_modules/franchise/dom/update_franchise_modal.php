<div class="modal fade" id="franchise_details_modal_update" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form id="franchise_update_details_form" class="form" method="post" enctype="multipart/form-data"
                    novalidate="novalidate" data-kt-redirect-url="<?= BASE_URL ?>/modules/franchise"
                    action="<?= BASE_URL ?>/modules/update_franchise">
                    ...
                    <div class="pt-5 d-flex justify-content-evenly">
                        ...
                        <button type="submit" id="update_franchise_details"
